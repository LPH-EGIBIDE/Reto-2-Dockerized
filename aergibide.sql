...
START TRANSACTION;
USE `docker`;
INSERT INTO `docker`.`users` (`id`, `username`, `email`, `password`, `type`, `profile_pic`, `profile_description`, `active`, `email_verified`, `points`, `mfa_type`, `mfa_data`, `password_reset_token`) VALUES (1, 'alex', 'alex.cortes@ikasle.egibide.org', '$2y$10$pAO5CX2Ima57UDp7h98uouLxthK/.wlpyZ0kgtf1VxeIhPM5eimVW', 1, 1, 'Full-stack developer para AERGIBIDE', 1, 1, 0, 1, 'UHQUFWGGHFL5NHO2', DEFAULT);
INSERT INTO `docker`.`users` (`id`, `username`, `email`, `password`, `type`, `profile_pic`, `profile_description`, `active`, `email_verified`, `points`, `mfa_type`, `mfa_data`, `password_reset_token`) VALUES (2, 'damian', 'damian.romero@ikasle.egibide.org', '$2y$10$pAO5CX2Ima57UDp7h98uouLxthK/.wlpyZ0kgtf1VxeIhPM5eimVW', 1, 2, 'Backend developer para AERGIBIDE', 1, 1, 0, 2, DEFAULT, DEFAULT);
INSERT INTO `docker`.`users` (`id`, `username`, `email`, `password`, `type`, `profile_pic`, `profile_description`, `active`, `email_verified`, `points`, `mfa_type`, `mfa_data`, `password_reset_token`) VALUES (3, 'julen', 'julen.martinez@ikasle.egibide.org', '$2y$10$pAO5CX2Ima57UDp7h98uouLxthK/.wlpyZ0kgtf1VxeIhPM5eimVW', 1, 3, 'Frontend developer para AERGIBIDE', 1, 1, 0, 0, DEFAULT, DEFAULT);
